    ...
    return(
        <>
                ...
                <div className={`${props.theme} neumorphism ${styles.container}`}>
                    ...
                    {props.sentIcon? <a href="#" className={styles.sendLink}><BsSend size={25} style={{ backgroundColor: "transparent"}}/></a> :null}
                    ...
                    {props.arrowIcon?<a href="#" className={styles.arrowLink}>

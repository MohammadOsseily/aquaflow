...
const Vendor: React.FC = () => {
    ...
    return (
        <div>
            <div className='pb-10 text-4xl'>Vendor DashBoard</div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <label className='input input-bordered flex items-center gap-2'>
                    Price:
                    <input type='text' name='price' value={price} onChange={handleChange} required className='grow' />
                </label>
                <label className='input input-bordered flex items-center gap-2'>
                    Stock:
                    <input type='text' name='stock' value={stock} onChange={handleChange} required className='grow' />
                </label>
                <label className='input input-bordered flex items-center gap-2'>
                    SKU:
